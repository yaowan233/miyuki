...
from typing import Optional, AbstractSet, Sequence
...
async def handle_majsoul_records(nickname: str, player_num: PlayerNum, *,
    ...
    if len(players) == 0:\
        msgs += UniMessage.text("没有查询到该角色在金之间以上的对局数据呢~")
    else:
        try:
